  ...
  return (
    <AppShell>
      <div className="px-5 pt-8 pb-6 space-y-6">
        ...
        <p className="text-sm text-muted-foreground">The Lamp Stand is proprietary software owned by APEX Business Systems LTD. Counsel-review items are marked in each legal page.</p>
