...
export default function TermsPage() {
  return (
    <LegalLayout title="Community Terms">
      ...
      <h2 className="text-lg font-semibold mt-6 mb-2">What TheLampStand is</h2>
      <p>
        TheLampStand is a community spiritual companion: a free, ad-free space for daily reflection,
      ...
      <h2 className="text-lg font-semibold mt-6 mb-2">What TheLampStand is not</h2>
      <p>
        TheLampStand's AI responses, reflections, and guidance are <strong>not</strong> a substitute for:
      </p>
      ...
      <p>By using TheLampStand you agree to:</p>
      <ul className="list-disc pl-6 space-y-1 mt-2">
      ...
      <p>
        TheLampStand is provided as-is by a small community team. We aim for reliability but cannot
