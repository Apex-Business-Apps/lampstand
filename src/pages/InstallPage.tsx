    ...
    <AppShell>
      <div className="px-5 pt-8 pb-12 space-y-6 max-w-xl mx-auto">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-serif font-semibold">Install TheLampStand</h1>
          <p className="text-sm text-muted-foreground">
            Add TheLampStand to your home screen so daily reminders, voice, and offline saves work like a native app.
          </p>
        </div>
        ...
        {installed ? (
          <div className="rounded-xl border border-primary/40 bg-accent/40 p-5 text-center space-y-3">
            ...
            <p className="font-medium">TheLampStand is installed.</p>
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5 space-y-4">
      ...
      <ol className="space-y-3">
        ...
        <Step n={4}>Open TheLampStand from your home screen and enable reminders in Settings.</Step>
      </ol>
    </div>
  );
}
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5 space-y-4">
      ...
      <ol className="space-y-3">
        ...
        <Step n={3}>TheLampStand opens in its own window with reminders enabled.</Step>
      </ol>
    </div>
  );
}
