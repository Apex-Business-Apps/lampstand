...
- AI/chat modules: `src/lib/agent/`, `src/lib/ai/`, `src/hooks/useAgentController.ts`, `src/lib/runtime/agentRuntime.ts`, `src/lib/groq.ts`.
...
- AI/chat behavior: verified in `src/lib/agent/ConversationOrchestrator.ts`, `src/lib/ai/AgentRuntime.ts`, `src/hooks/useAgentController.ts`, `src/components/FloatingAgent.tsx`, and `src/components/FullscreenAgent.tsx`.
